...
def check_pass_file():
         if not os.path.isfile(passwrdJSON):
            print(Colorate.Horizontal(Colors.blue_to_purple,'Password file not found.\nCreate one with option (8) Reset Password.'))
            input(Colorate.Horizontal(Colors.blue_to_purple, 'Press enter to exit...'))
            exit()
...
while True:
    ...
    if shell.isdigit():
        ...
        if shell == 0:
            ...
            print(Colorate.Horizontal(Colors.blue_to_purple, f"Current Time: {formatted_time}"))
            input(Colorate.Horizontal(Colors.blue_to_purple, 'Press enter to exit...'))
        elif shell == 6:
            print(Colorate.Horizontal(Colors.blue_to_purple, 'Encode or decode'))
            decide = input(Colorate.Horizontal(Colors.blue_to_purple, "Type 'encode' or 'decode': ")).strip().lower()
            if decide == "encode":
            ...
            print(Colorate.Horizontal(Colors.blue_to_purple,'Goofy goober'))
            input(Colorate.Horizontal(Colors.blue_to_purple,'Press enter to exit...'))
